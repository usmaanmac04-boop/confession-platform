  ...
  const Home = () => {
    ...
    return (
      <div className="min-h-screen relative" style={{
          background: 'linear-gradient(-45deg, #fae8ff, #ddd6fe, #fbcfe8, #e0e7ff, #fce7f3)',
  ...
  <p className="text-sm sm:text-base text-gray-600">Express yourself freely, without judgment</p>
          </div>
          ...
          <div className="space-y-4">
            {loading ? (
              <div className="text-center py-12 text-gray-500">Loading confessions...</div>
